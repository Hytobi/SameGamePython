...
class VueSame :
    ...
    def __init__(self, same):
        ...
        for i in range(1, 9):
            img = tkinter.PhotoImage(file = "./img/medium_sphere"+str(i)+"black.gif")
        ...
        #Le Score
        self.__score = tkinter.Label(fenetre, text='Score: ' + str(self.__same.score()))
        self.__score.grid(row=round(same.nblig()/2)-2, column=same.nbcol()+1)
